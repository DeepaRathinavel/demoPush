...
public class FixMyBugs {
	...
	public void fixMyBugs() throws InterruptedException
	{
		...
		driver.findElementByXPath("//ul[@class='categories-list']/li[1]/label/span").getText().replaceAll("//D", "");
		...
		// Check the count
		String rightCount = 
				driver.findElementByXPath("//span[@class='horizontal-filters-sub']").getText().replaceAll("//D", "");
